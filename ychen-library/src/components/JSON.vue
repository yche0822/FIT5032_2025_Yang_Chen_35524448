...
const modernAuthors = computed(() => {return authors.filter((author) => author.birthYear > 1850)
  // TODO: CODE TO FILTER ARRAY OF AUTHORS HERE
})

// Activity 3: Get all famous works
const allFamousWorks = computed(() => {return authors.flatMap((author) => author.famousWorks.map((work) => work.title))
...
const austen = computed(() => {return authors.find((author) => author.id === 1)
